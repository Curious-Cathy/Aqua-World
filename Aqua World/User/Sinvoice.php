...
$sele="select * from tbl_productbooking b inner join  tbl_stonetype  t on b.stype_id=t.stype_id inner join
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="left"><?php echo $data["stype_name"]; ?></td>
                                    <td class="left"></td>
                                    <td class="center"><?php echo $data["quantity"];?></td>
                                    <td class="right">Rs.<?php echo $data["stype_rate"]; ?></td>
