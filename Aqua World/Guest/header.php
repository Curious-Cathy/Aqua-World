              ...
              <div class="top"> <!-- top -->
                  <div class="container">
                      <ul class="top-support"> 
                          ...
                          <li><a href=""><i class="fa fa-envelope-square"></i><span>info@quaworldorld.com</span></a></li>
                      </ul>
                              ...
                              <!-- <div class="container-fluid"> -->
                                  ...
                                  <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                                      <ul class="nav navbar-nav">
                                          <li><a href="../Index/index.html">Home <span class="sr-only"></span></a></li>
                                          <li><a href="User.php">NewUser</a></li>
                                          <li></li>
