...
$sele="select * from tbl_productbooking b inner join  tbl_accessories  t on b.accessories_id=t.accessories_id inner join
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="left"><?php echo $data["accessories_name"]; ?></td>
                                    <td class="left"></td>
                                    <td class="center"><?php echo $data["quantity"];?></td>
                                    <td class="right">Rs.<?php echo $data["accessories_rate"]; ?></td>
