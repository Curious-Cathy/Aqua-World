...
$sele="select * from tbl_productbooking b inner join tbl_fish t on b.fish_id=t.fish_id inner join
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="left"><?php echo $data["fish_name"]; ?></td>
                                    <td class="left"><?php echo $data["fish_description"]; ?></td>
                                    <td class="center"><?php echo $data["quantity"]; ?></td>
                                    <td class="right">Rs.<?php echo $data["fish_price"]; ?></td>
...
<script type="text/javascript">
    function showAlert() {
        ...
        window.location.href = "Viewfishdetails.php"; 
    }
