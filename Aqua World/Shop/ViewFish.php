...
mysqil_query($conn,$upquery); 
echo "<script> alert ('Booking Accepted');</script>";
header("location:ViewFish.php");
//echo $upquery;
...
<tr>
<td align="center"width="123" height="50">Fish Name</td>
...
$sel="select * from tbl_productbooking b inner join tbl_fish t on b.fish_id=t.fish_id inner join
...
<td><img width="200" height="150" src="../Assets/Fishimage/<?php echo $row["fish_image"] ?>" /></td>
...
<td align="center" width="127"><a href="ViewFish.php?acc=<?php echo $row["pbooking_id"];?>" onclick ="return accept()">Accept</a></td>

<td align="center" width="209"><a href="ViewFish.php?rej=<?php echo $row["pbooking_id"];?>" onclick ="return reject()">Reject</a></td>
</tr>
<?php
}
?>
