...
{	
		  ...
		  $del="delete from tbl_productbooking		where pbooking_id='".$id."'" ;
		   ...
		   header("location:ViewFbookinglist.php");
...
<form id="form1" name="form1" method="post" action="">
  <p>&nbsp;</p>
  <p>&nbsp;</p>
  <table align="center" width="1020" border="1" cellspacing="4" cellpadding="0">
  <tr>
        ...
        <td align="center" style="color:red">
         <?php
		  if($row["booking_status"]==0){ echo "Pending";} 
           ...
           <td align="center" width="209"><a href="ViewFbookinglist.php?cancel=<?php echo $row["pbooking_id"];?>">Cancel</a></td>
        </tr>
      <?php
	}
	?>
